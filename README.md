...
Вариант 1: Скачать напрямую
    Перейдите по ссылке на модель - 
    Скачайте файл и поместите в директорию models/ проекта

Вариант 2: Использовать DVC (если у вас есть доступ к Яндекс Диску проекта)

    dvc remote modify --local myremote token <YOUR_YANDEX_OAUTH_TOKEN>
    dvc pull
